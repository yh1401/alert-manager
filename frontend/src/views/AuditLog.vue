    ...
    <div class="audit-log-container">
        <el-card shadow="hover">
            ...
            <el-form :inline="true" :model="filterForm" class="filter-form">
                ...
                <el-form-item label="操作类型">
                    ...
                    >
                        ...
                        <el-option label="同步" value="manual_sync" />
                    </el-select>
                </el-form-item>
            ...
            <div class="stats-cards" v-if="stats">
                <el-row :gutter="16">
                    <el-col
                        style="width: 20%; max-width: 20%; flex: 0 0 20%"
            ...
            >
                ...
                >
                    <template #default="{ row }">
                        ...
                        >
                        <el-tag
                            v-else-if="row.action === 'rollback'"
                            type="warning"
                            size="small"
                            >回滚</el-tag
                        >
                        <el-tag
                            v-else-if="row.action === 'manual_sync'"
                            type="primary"
                            size="small"
                            >同步</el-tag
                        >
        ...
        >
            <div v-if="currentDetail" class="detail-content">
                <el-descriptions :column="2" border>
                    ...
                    <el-descriptions-item label="操作人">
                        <el-tag
                            v-if="currentDetail.user_id === 0"
                            type="info"
                            size="small"
                            >系统</el-tag
                        >
                        <span v-else
                            >{{ currentDetail.username }} (ID:
                            {{ currentDetail.user_id }})</span
                        >
                    </el-descriptions-item>
                    <el-descriptions-item label="资源类型">
                        <el-tag
                            v-if="currentDetail.resource_type === 'rule'"
                            type="primary"
                            size="small"
                            >规则</el-tag
                        >
                    ...
                    <el-descriptions-item label="操作类型">
                        <el-tag
                            v-if="currentDetail.action === 'create'"
                            type="success"
                            size="small"
                            >创建</el-tag
                        >
                        <el-tag
                            v-else-if="currentDetail.action === 'update'"
                            type="primary"
                            size="small"
                            >更新</el-tag
                        >
                        ...
                        >
                        <el-tag
                            v-else-if="currentDetail.action === 'rollback'"
                            type="warning"
                            size="small"
                            >回滚</el-tag
                        >
                        <el-tag
                            v-else-if="currentDetail.action === 'manual_sync'"
                            type="primary"
                            size="small"
                            >同步</el-tag
                        >
                        ...
                        <el-col :span="12">
                            <el-card shadow="hover">
                                ...
                                <pre class="json-content">{{
                                    formatJSON(currentDetail.old_value)
                                }}</pre>
                            </el-card>
                        </el-col>
                        <el-col :span="12">
                            <el-card shadow="hover">
                                ...
                                <pre class="json-content">{{
                                    formatJSON(currentDetail.new_value)
                                }}</pre>
                            </el-card>
                        </el-col>
                    </el-row>
            ...
            <template #footer>
                <el-button
                    v-if="
                        currentDetail &&
                        currentDetail.resource_type === 'rule' &&
                        currentDetail.action === 'delete'
                    "
                    type="warning"
                    :loading="restoring"
                    :icon="RefreshLeft"
...
const statsDisplay = computed(() => {
    ...
    while (result.length < 5) {
        result.push({
            label: "总操作数",
            value:
                stats.value.action_stats?.reduce(
                    (sum, s) => sum + s.Count,
                    0,
                ) || 0,
            icon: DataAnalysis,
